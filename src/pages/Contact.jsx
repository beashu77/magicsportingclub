  ...
  return (
    <>
      <div className="bg-light_grey p-24">
        <p className="md:text-5xl text-2xl text-center">
      ...
      <p className="py-10 block">
        ...
        <div className=" mb-20 flex flex-col md:flex-row justify-between ">
          ...
          <div className=" md:w-[50%] w-[100%]">
            ...
            <h1 className="text-black font-figtreeBold text-5xl pb-5">
              Let's Talk
            </h1>
            <h3 className="text-2xl font-figtreeMedium text-yellow_dark">
